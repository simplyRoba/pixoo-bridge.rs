# pixoo-http-client Specification

## Purpose
Define the Pixoo HTTP client behavior for issuing command payloads and interpreting device responses over the proprietary API.
