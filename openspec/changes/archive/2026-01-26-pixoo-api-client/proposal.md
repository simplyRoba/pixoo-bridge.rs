...
### New Capabilities
- `core`: Define how the bridge constructs POST requests for Pixoo commands, parses response payloads despite inconsistent content-types, and returns structured data after `error_code` validation.
