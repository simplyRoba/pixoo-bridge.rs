...
* add permissive CORS middleware for browser-based clients ([b997ff3](https://github.com/simplyRoba/pixoo-bridge.rs/commit/b997ff32820406c97d0cb4e2254237a19f5e1501))
...
* **deps:** bump tokio from 1.52.1 to 1.52.2 in the tokio group ([208985d](https://github.com/simplyRoba/pixoo-bridge.rs/commit/208985dcf25300e04654d397ffb31504497c3f88))
* **deps:** bump tokio from 1.52.2 to 1.52.3 in the tokio group ([43b3b2a](https://github.com/simplyRoba/pixoo-bridge.rs/commit/43b3b2aa02ed4572cd0eaf2bb786bd9669b32742))
* **deps:** bump tower-http from 0.6.10 to 0.6.11 ([5901c99](https://github.com/simplyRoba/pixoo-bridge.rs/commit/5901c99f585faa3dc9ea494d64648d5b8e80cb42))
* **deps:** bump tower-http from 0.6.8 to 0.6.9 ([d4de166](https://github.com/simplyRoba/pixoo-bridge.rs/commit/d4de166db001a3cd9512875b0738107036abae22))
* **deps:** bump tower-http from 0.6.9 to 0.6.10 ([947108e](https://github.com/simplyRoba/pixoo-bridge.rs/commit/947108e763003493d948a29a035577db0335b6e6))
...
* **ci:** bump actions/download-artifact from 7 to 8 ([cd05b9e](https://github.com/simplyRoba/pixoo-bridge.rs/commit/cd05b9e7bef8024b3fcd52662feae8a7c0b8e9bc))
* **ci:** bump actions/upload-artifact from 6 to 7 ([26bc385](https://github.com/simplyRoba/pixoo-bridge.rs/commit/26bc385d6b5b657051ca02e6274e32852a548624))
* **ci:** bump docker/login-action from 3 to 4 ([a960c81](https://github.com/simplyRoba/pixoo-bridge.rs/commit/a960c8126476f1f8be345be9b08b8e1eed626e65))
* **ci:** bump docker/setup-buildx-action from 3 to 4 ([b7318db](https://github.com/simplyRoba/pixoo-bridge.rs/commit/b7318dbfb43b8b0b332e2e8803982767ef08a177))
...
* **deps:** bump chrono from 0.4.43 to 0.4.44 ([0edf410](https://github.com/simplyRoba/pixoo-bridge.rs/commit/0edf41073bbf647c9a79fe1105927b02006d1113))
...
* **deps:** bump tokio from 1.49.0 to 1.50.0 ([fa777c2](https://github.com/simplyRoba/pixoo-bridge.rs/commit/fa777c2a49aba8ae7849291cfe418fa4431a486d))
